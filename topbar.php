            ...
            <ul class="navbar-nav flex-row align-items-center ms-md-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end mt-3 py-2">
                        ...
                        <li>
                            <a class="dropdown-item"
                                href="https://demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/pages-profile-user.html">
                        ...
                        <li>
                            <div class="d-grid px-4 pt-2 pb-1">
                                <a class="btn btn-danger d-flex"
                                    href="https://demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/auth-login-cover.html"
                                    target="_blank">
