<?php include_once('header-plain.php'); ?>
  ...
  <div class="authentication-wrapper authentication-cover">
    <!-- Logo -->
    <a href="https://demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/index.html" class="auth-cover-brand d-flex align-items-center gap-3">
  ...
  <span class="text-primary">
    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-12 pb-2">
        <div>
          <img src="https://demos.themeselection.com/materio-bootstrap-html-admin-template/assets/img/illustrations/auth-cover-login-illustration-light.png" class="authentication-image-model d-none d-lg-block" alt="auth-model" data-app-light-img="illustrations/auth-cover-login-illustration-light.png" data-app-dark-img="https://demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/illustrations/auth-cover-login-illustration-dark.png" />
        </div>
        <img src="https://demos.themeselection.com/materio-bootstrap-html-admin-template/assets/img/illustrations/tree.png" alt="tree" class="authentication-image-tree z-n1" />
        <img src="https://demos.themeselection.com/materio-bootstrap-html-admin-template/assets/img/illustrations/auth-cover-mask-light.png" class="scaleX-n1-rtl authentication-image d-none d-lg-block w-75" alt="triangle-bg" height="362" data-app-light-img="illustrations/auth-cover-mask-light.png" data-app-dark-img="https://demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/illustrations/auth-cover-mask-dark.png" />
      </div>
      <!-- /Left Section -->
        ...
        <div class="w-px-400 mx-auto pt-12 pt-lg-0">
          ...
          <form id="formAuthentication" class="mb-5" action="https://demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/index.html" method="GET">
            ...
            <div class="mb-5 d-flex justify-content-between flex-wrap py-2">
              ...
              <a href="https://demos.themeselection.com/materio-bootstrap-html-admin-template/html/vertical-menu-template/auth-forgot-password-cover.html" class="float-end mb-1">
