        ...
        <?php foreach ($sub_module_list as $sub_module) {
            if ($sub_module['module_name'] == $module['module_name']) {
                ...
                <div class="sub-module ">
                    ...
                    <h5><?php echo $sub_module['module_topic']; ?></h5>
                    ...
                    foreach ($user_level_list as $u) {
                        ...
                        ?>
                        <div class="role-box">
                            <h6 style="display:inline-block; margin:0;"><?php echo $u['userlevel'] . '//' . $cur_id; ?></h6>
                            <select class="permission-select" data-id="<?php echo $p['id']; ?>"
                                ...
                                data-page="<?php echo $page_name; ?>" style="color:<?php echo $perm_color[$current_permission]; ?>;">
