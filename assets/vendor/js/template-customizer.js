  ...
  return (function () {
        ...
        function i(e, i) {
          for (var a = {}, s = [], r = 0; r < e.length; r++) {
            ...
            if (-1 !== m) t[m].references++, t[m].updater(p);
              ...
              var h = n(p, i);
              (i.byIndex = r),
                t.splice(r, 0, { identifier: d, updater: h, references: 1 });
            }
            s.push(d);
          }
          return s;
    ...
    return (
      (function () {
        ...
        t()(h.Z, g), h.Z && h.Z.locals && h.Z.locals;
        function v(e) {
          return (
            (v =
        ...
        var z,
          ...
          A = S.contains("layout-menu-offcanvas")
            ...
            : S.contains("layout-menu-fixed")
              ...
              : S.contains("layout-menu-fixed-offcanvas")
                ? "fixed-offcanvas"
                : "static",
          E = !!S.contains("layout-menu-collapsed"),
          L = y,
          ...
          D = (function () {
            function e(t) {
              var o = t.displayCustomizer,
                i = t.lang,
                n = t.defaultPrimaryColor,
                a = t.defaultSkin,
                s = t.defaultTheme,
                r = t.defaultSemiDark,
                l = t.defaultContentLayout,
                c = t.defaultHeaderType,
                u = t.defaultMenuCollapsed,
                d = t.defaultNavbarType,
                m = t.defaultTextDir,
                p = t.defaultFooterFixed,
                h = t.defaultShowDropdownOnHover,
                g = t.controls,
                v = t.themes,
                b = t.availableColors,
                f = t.availableSkins,
                y = t.availableThemes,
                S = t.availableContentLayouts,
                D = t.availableHeaderTypes,
                q = t.availableMenuCollapsed,
                I = t.availableNavbarOptions,
                H = t.availableDirections,
                F = t.onSettingsChange;
              if (
                ((function (e, t) {
                  if (!(e instanceof t))
                ...
                if (
                  ((this.settings = {}),
                    ...
                    (this.settings.defaultMenuCollapsed = void 0 !== u ? u : E),
                    (this.settings.defaultNavbarType = void 0 !== d ? d : L),
                    ...
                    (this.settings.availableColors = b || e.COLORS),
                    (this.settings.availableSkins = f || e.SKINS),
                    (this.settings.availableThemes = y || e.THEMES),
                    (this.settings.availableContentLayouts = S || e.CONTENT),
                    (this.settings.availableHeaderTypes = D || e.HEADER_TYPES),
                    (this.settings.availableMenuCollapsed = q || e.LAYOUTS),
                    (this.settings.availableNavbarOptions =
                      I || e.NAVBAR_OPTIONS),
                    (this.settings.availableDirections = H || e.DIRECTIONS),
              ...
              (o = [
                {
                  ...
                  value: function (e) {
                    var t =
                      ...
                      void 0 !== arguments[1] &&
                      arguments[1];
                    window.Helpers.setColor(e, t);
                  },
                },
                {
                  key: "setTheme",
                  value: function (e) {
                    this._setSetting("Theme", e);
                  },
                },
                {
                  key: "setSkin",
                  value: function (e) {
                    ...
                    if (this._hasControls("skins")) {
                      var o = this._getSkinByName(e);
                      o &&
                        ((this.settings.skin = o),
                          t && this._setSetting("Skin", e),
                          t &&
                  ...
                  value: function (e) {
                    ...
                    this._hasControls("layoutNavbarOptions") &&
                      ((this.settings.layoutNavbarOptions = e),
                        t && this._setSetting("FixedNavbarOption", e),
                        window.Helpers.setNavbar(e),
                        t &&
                        this.settings.onSettingsChange.call(
                          this,
                          this.settings
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    this._hasControls("contentLayout") &&
                      ((this.settings.contentLayout = e),
                        t && this._setSetting("contentLayout", e),
                        window.Helpers.setContentLayout(e),
                        t &&
                        this.settings.onSettingsChange.call(
                          this,
                          this.settings
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (
                      ...
                      (this.settings.headerType = e),
                        t && this._setSetting("HeaderType", e),
                        window.Helpers.setPosition(
                          "fixed" === e || "fixed-offcanvas" === e,
                          "static-offcanvas" === e || "fixed-offcanvas" === e
                        ),
                        t &&
                        this.settings.onSettingsChange.call(
                          this,
                ...
                },
                {
                  ...
                  value: function (e) {
                    var t =
                      !(arguments.length > 1 && void 0 !== arguments[1]) ||
                      arguments[1];
                    (this.settings.layoutFooterFixed = e),
                      t && this._setSetting("FixedFooter", e),
                      window.Helpers.setFooterFixed(e),
                      t &&
                      this.settings.onSettingsChange.call(
                        this,
                        this.settings
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    if (this._hasControls("showDropdownOnHover")) {
                      if (
                        ((this.settings.showDropdownOnHover = e),
                          t && this._setSetting("ShowDropdownOnHover", e),
                          window.Helpers.mainMenu)
                      ) {
                        window.Helpers.mainMenu.destroy(),
                          (config.showDropdownOnHover = e);
                        var o = window.Menu;
                  ...
                  value: function (t) {
                    var o = this,
                      ...
                      n =
                        ...
                        void 0 !== arguments[2] &&
                        arguments[2];
                    if (t !== this.settings.lang || n) {
                      if (!e.LANGUAGES[t])
                        throw new Error('Language "'.concat(t, '" not found!'));
                      var a = e.LANGUAGES[t];
                      [
                        "panel_header",
                        "panel_sub_header",
                        ...
                        var t = o.container.querySelector(
                          ".template-customizer-t-".concat(e)
                        );
                        t && (t.textContent = a[e]);
                      }),
                        (this.settings.lang = t),
                        i && this._setSetting("Lang", t),
                        i &&
                        this.settings.onSettingsChange.call(
                          this,
                          this.settings
                ...
                },
                {
                  ...
                  value: function () {
                    if (!this._ssr) {
                      var e = !!document.querySelector(".layout-navbar"),
                        t = !!document.querySelector(".layout-menu"),
                  ...
                  value: function () {
                    if (!this._ssr) {
                      ...
                      [
                        ...
                        var o = "templateCustomizer-".concat(e, "--").concat(t);
                ...
                },
                {
                  key: "_loadSettings",
                  value: function () {
                    var e = this._getSetting("Rtl"),
                      t = this._getSetting("Color"),
                    ...
                    e || o || i || a || s || l || u || t || n
                      ...
                      t && (z = !0),
                      (this.settings.color =
                        t || this.settings.defaultPrimaryColor),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var i = this.container.querySelector(
                      ...
                      n = function () {
                        e.container.classList.add("template-customizer-open"),
                          e.update(),
                          e._updateInterval && clearInterval(e._updateInterval),
                          (e._updateInterval = setInterval(function () {
                            e.update();
                          }, 500));
                      };
                    ...
                    var a = this.container.querySelector(
                      ...
                      s = function () {
                        e.clearLocalStorage(), window.location.reload();
                      };
                    ...
                    var r = this.container.querySelector(
                      ...
                      l = function () {
                        e.container.classList.remove(
                          ...
                          e._updateInterval &&
                          (clearInterval(e._updateInterval),
                            (e._updateInterval = null));
                      };
                    ...
                    if (this._hasControls("color")) {
                      ...
                      this.settings.availableColors.forEach(function (t) {
                        var o =
                      ...
                      var p = function (t) {
                        "picker" === t.target.value
                          ? document
                            .querySelector(
                              ".custom-option-content .pcr-button"
                            )
                            .click()
                          : (e._setSetting("Color", t.target.dataset.color),
                            e.setColor(
                    ...
                    if (this._hasControls("theme")) {
                      ...
                      var v = function (t) {
                        ...
                        window.Helpers.syncThemeToggles(t.target.value),
                          e.setTheme(t.target.value, !0, function () {
                            e._loadingState(!1);
                          });
                      };
                    ...
                    if (this._hasControls("skins")) {
                      this.settings.availableSkins.forEach(function (e) {
                        var t = o(e.name, e.title, "skinRadios", e.image);
                        f.appendChild(t);
                      }),
                        f
                          .querySelector(
                      ...
                      var y = function (t) {
                        document.documentElement.setAttribute(
                          ...
                          e.setSkin(t.target.value, !0, function () {
                            e._loadingState(!1, !0);
                          });
                      };
                    ...
                    if (
                      ...
                      if (this._hasControls("layoutCollapsed")) {
                        ...
                        this.settings.availableMenuCollapsed.forEach(function (
                          ...
                          var t = o(e.name, e.title, "layoutsRadios", e.image);
                          x.appendChild(t);
                        }),
                          x
                            .querySelector(
                      ...
                      if (this._hasControls("contentLayout")) {
                        ...
                        var N = function (t) {
                          (e._loading = !0),
                            e._loadingState(!0, !0),
                            e.setContentLayout(t.target.value, !0, function () {
                              (e._loading = !1), e._loadingState(!1, !0);
                            });
                        };
                        L.addEventListener("change", N),
                          this._listeners.push([L, "change", N]);
                      ...
                      if (this._hasControls("headerType")) {
                        ...
                        var q = function (t) {
                          e.setHeaderType(t.target.value);
                        };
                      ...
                      if (this._hasControls("layoutNavbarOptions")) {
                        ...
                        H.addEventListener("change", F),
                          this._listeners.push([H, "change", F]);
                      ...
                      if (this._hasControls("rtl")) {
                        ...
                        var R = function (t) {
                          e._setSetting("Lang", e.settings.lang),
                            e._setSetting(
                              "Lang",
                              "ar" === e.settings.lang ? "en" : "ar"
                            ),
                            (e.settings.rtl = "rtl" === t.target.value);
                          var o = e._getSetting("Lang"),
                          ...
                          i &&
                            i
                              ...
                              .click(),
                            e._initDirection(),
                            e.setRtl("rtl" === t.target.value, !0, function () {
                              e._loadingState(!1);
                            });
                        };
                        M.addEventListener("change", R),
                          this._listeners.push([M, "change", R]);
                      } else B.parentNode.removeChild(B);
                      ...
                      t === document
                        ? t.body
                          ...
                          : window.addEventListener(
                            "DOMContentLoaded",
                            function () {
                              return t.body.appendChild(e.container);
                            }
                          )
                ...
                },
                {
                  key: "_loadingState",
                  value: function (e, t) {
                    this.container.classList[e ? "add" : "remove"](
                      "template-customizer-loading".concat(t ? "-theme" : "")
                    );
                  },
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    try {
                      localStorage.setItem(
                        "templateCustomizer-".concat(o, "--").concat(e),
                        String(t)
                      ),
                ...
                },
                {
                  ...
                  value: function () {
                    for (var e = 0, t = this._listeners.length; e < t; e++)
                      this._listeners[e][0].removeEventListener(
                        this._listeners[e][1],
                        this._listeners[e][2]
                      );
                  },
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    return e.split(" ").reduce(function (e, i) {
                      return (
                        -1 !== t.settings.controls.indexOf(i)
                          ? (o || !1 !== e) && (e = !0)
                          : (o && !0 === e) || (e = !1),
                        e
                      );
                ...
                },
                {
                  ...
                  value: function (e) {
                    var t =
                      "string" == typeof e
                        ? this._getSkinByName(e, !1)
                        : this.settings.availableSkins[e];
                    if (!t)
                      throw new Error('Skin ID "'.concat(e, '" not found!'));
                    return t;
                  },
                },
                {
                  ...
                  value: function (e) {
                    for (
                      ...
                      if (o[i].name === e) return o[i];
                    return t ? this.settings.defaultSkin : null;
                  },
                },
              ]),
              o && b(t.prototype, o),
        ...
        window.onload = function () {
          !(function () {
            ...
            if (e.pickerWrapper && e.pickerEl) {
              var t =
                "checked" === e.pickerWrapper.getAttribute("checked")
                  ? window.templateCustomizer._getSetting("Color")
                    ? window.templateCustomizer._getSetting("Color")
                    : window.templateCustomizer.settings.defaultPrimaryColor
                  : window.Helpers.getCssVar("gray-900", !0),
                o = new Pickr({
                  el: e.pickerEl,
                  theme: "nano",
                  default: t,
              ...
              o._root.button.classList.add("ri", "ri-palette-line"),
                o.on("change", function (t) {
                  ...
                  null === (o = e.pcrButton) ||
                    ...
                    (e.pickerWrapper.checked = !0),
                    window.Helpers.updateCustomOptionCheck(e.pickerWrapper),
                    window.templateCustomizer._setSetting("Color", i),
                    window.templateCustomizer.setColor(i, !0);
                });
            }
          })();
          var e = document.querySelector(".custom-option-content .pcr-button");
          null == e ||
            e.style.setProperty(
              "--pcr-color",
              window.templateCustomizer.settings.defaultPrimaryColor
