...
document.addEventListener("DOMContentLoaded", function (e) {
  ...
  var f = {
    ...
    u = document.querySelector("#shipmentStatisticsChart"),
    h = {
      series: [
        {
          name: "Shipment",
      ...
      grid: { strokeDashArray: 8, borderColor: o },
      colors: [f.line.series1, f.line.series2],
      fill: { opacity: [1, 1] },
      plotOptions: {
        bar: {
          columnWidth: "30%",
    ...
    u =
      (null !== u && new ApexCharts(u, h).render(),
      document.querySelector("#deliveryExceptionsChart")),
    h = {
      chart: { height: 388, parentHeightOffset: 0, type: "donut" },
      labels: [
        "Incorrect address",
        "Weather conditions",
        "Federal Holidays",
      ...
      legend: {
        ...
        position: "bottom",
        offsetY: 10,
        markers: { width: 8, height: 8, offsetX: -3, strokeWidth: 0 },
  ...
  f &&
    new DataTable(f, {
      ...
      columnDefs: [
        ...
        },
        {
          targets: 3,
          render: (e, t, s) => {
            var { start_city: s, start_country: r } = s;
            return `
                  <div class="text-body">
                      ${s}, ${r}
                  </div>
        ...
        },
        {
          targets: 4,
          render: (e, t, s) => {
            var { end_city: s, end_country: r } = s;
            return `
                  <div class="text-body">
                      ${s}, ${r}
                  </div>
          ...
          render: (e, t, s) => {
            ...
            return `
                  <div class="d-flex align-items-center">
                      ...
                      <div class="text-body ms-3">${s}%</div>
                  </div>
              `;
          },
        },
      ...
      responsive: {
        details: {
          ...
          renderer: function (e, t, s) {
            ...
            return (
              !!s &&
              ((r = document.createElement("table")).classList.add(
                "table",
                "datatables-basic",
                "mb-2"
              ),
              ((o = document.createElement("tbody")).innerHTML = s),
              r.appendChild(o),
              r)
            );
          },
    ...
    setTimeout(() => {
      ...
      ].forEach(({ selector: e, classToRemove: s, classToAdd: r }) => {
