...
<div class="container-xxl flex-grow-1 container-p-y">
            ...
            <div class="card card-border-shadow-primary h-100">
                <div class="card-body">
                    ...
                    <p class="mb-0">
                        ...
                        echo $sctype;
                        echo $usr; ?>
                        <button class="btn btn-primary backend-login"  data-mail="msaidur592rahman@gmail.com" data-feature="Page Tour"  data-point="3">Start tour</button>
    ...
    <!--/ Card Border Shadow -->
    <div class="row g-6 d-flex align-items-stretch">
        <!-- Vehicles overview -->
                ...
                <div class="card-body pb-2">
                    <div class="d-none d-lg-flex vehicles-progress-labels mb-5">
                        ...
                        <div class="vehicles-progress-label loading-text" style="width: 17.4%;">
                            Loading</div>
                        <div class="vehicles-progress-label waiting-text" style="width: 14.6%;">
                            Waiting</div>
                    </div>
                    <div class="vehicles-overview-progress progress rounded bg-transparent mb-2" style="height: 46px;">
                        ...
                        <div class="progress-bar small fw-medium text-start text-bg-info px-1 px-lg-4"
                            role="progressbar" style="width: 17.4%" aria-valuenow="17.4" aria-valuemin="0"
                            aria-valuemax="100">17.4%</div>
                        <div class="progress-bar small fw-medium text-start bg-gray-900 rounded-end px-1 px-lg-4"
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr>
                                    <td class="w-75 ps-0">
                                        <div class="d-flex justify-content-start align-items-center">
                                            <div class="me-2">
                                                <i class="text-heading icon-base ri ri-car-line icon-24px"></i>
                                            </div>
                                ...
                                <tr>
                                    <td class="w-75 ps-0">
                                        <div class="d-flex justify-content-start align-items-center">
                                            <div class="me-2">
                                                <i class="text-heading icon-base ri ri-download-line icon-24px"></i>
                                            </div>
                                ...
                                <tr>
                                    <td class="w-75 ps-0">
                                        <div class="d-flex justify-content-start align-items-center">
                                            <div class="me-2">
                                                <i class="text-heading icon-base ri ri-upload-line icon-24px"></i>
                                            </div>
        ...
        <div class="col-md-6 col-xxl-4 order-1 order-xxl-3">
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <div class="dropdown">
                        <button class="btn text-body-secondary p-0" type="button" id="deliveryExceptions"
                ...
                <div class="card-body p-0">
                    <div class="nav-align-top">
                        <ul class="nav nav-tabs nav-fill tabs-line border-bottom-0" role="tablist">
                            ...
                            <li class="nav-item">
                                <button type="button" class="nav-link" role="tab" data-bs-toggle="tab"
                                    data-bs-target="#navs-justified-link-shipping" data-feature="Shipping" data-point="1"
                                ...
                                <ul class="timeline mb-0">
                                    ...
                                    <li class="timeline-item ps-6 border-transparent">
                                        ...
                                        <div class="timeline-event ps-1">
                                            ...
                                            <p class="mb-0 small">487 Sunset, California(CA), 94043
                                            </p>
                                        </div>
                                    </li>
                                </ul>
