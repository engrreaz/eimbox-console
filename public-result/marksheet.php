...
foreach ($subject_codes_raw as $sub_code) {
    ...
    $marks_data[$sub_code] = [
        ...
        'full' => $full_marks,
        'obtained' => $total_mark,
        'sub' => $result_summary[$col_prefix . '_sub'] ?? "",
        'obj' => $result_summary[$col_prefix . '_obj'] ?? "",
        'pra' => $result_summary[$col_prefix . '_pra'] ?? "",
        'ca' => $result_summary[$col_prefix . '_ca'] ?? "",
        ...
        <table class="table table-bordered table-sm marks-table text-center">
            <thead class="table-light">
                <tr>
                    ...
                    <th colspan="2">Grade</th> <th>Result</th> 
                </tr>
            </thead>
            <tbody>
                <?php
...
<tr>
                        ...
                        <?php if (!$summary_cell_added): ?>
                            <td rowspan="<?php echo $sub_count; ?>" class="align-middle">
                                <div class="p-2" >
                                    <p class="mb-1">Total Marks:<br><strong><?php echo htmlspecialchars($result_summary['totalmarks']); ?></strong> out of <?php echo htmlspecialchars($result_summary['full_marks']); ?></p>
