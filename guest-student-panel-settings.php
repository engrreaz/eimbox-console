        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="form-check form-switch mb-2">
                    <input class="form-check-input " style="width:50px; margin-right:10px; " type="checkbox"
                        name="panel_active" value="yes" <?= g($settings, 'panel_active') == 'yes' ? 'checked' : '' ?>>
                    <label class="form-check-label">Panel Active</label>
                </div>
                <div class="fs-small text-secondary" style="margin-left:60px;">
                    Enable or disable the guest student panel for users with guest access. After enable this features
                    anybody can login as a student without any credentions. It's need only some information to login
                    like session, class, section roll no. <br> You may also set some mandatory extra information to
                ...
                <!-- Login Security -->
                <b>Login Security</b><br>
                <?php
                $sec = ['Class Teacher', 'DOB', 'Mobile Number', 'Name', 'ID Number', 'Village', 'Blood Group'];
                foreach ($sec as $s):
                    ?>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" name="login_security[]" value="<?= $s ?>"
