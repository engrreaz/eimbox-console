<nav class="layout-navbar container-xxl navbar-detached navbar navbar-expand-xl align-items-center bg-navbar-theme"
    ...
    <div class="navbar-nav-right d-flex align-items-center justify-content-end" id="navbar-collapse">
        ...
        <div class="me-8">
            ...
            <div class="p-0 m-0 pt-1 text-muted fs-tiny ">Name of Institution</div>
            ...
            <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                <a class="nav-link position-relative" href="#" id="notifDropdown" role="button"
                    ...
                    <span id="notifCountBadge"
                        ...
                        style="display:flex;">0</span>
                </a>
                <ul class="dropdown-menu dropdown-menu-end p-0 shadow" aria-labelledby="notifDropdown"
                    style="width: 320px;">
                    <li class="px-3 py-2 d-flex justify-content-between align-items-center border-bottom">
                        <strong>Notifications</strong>
                        <small><a href="#" id="markAllRead" class="small text-decoration-none">Mark all read</a></small>
                    </li>
                    <li>
                        <div id="notifList" style="max-height: 360px; overflow:auto;" class="bg-light"></div>
                    </li>
                    <li class="text-center py-2 border-top">
                        <a href="notifications.php" class="text-decoration-none">See all</a>
                    </li>
                </ul>
            </li>
...
<div class="modal fade" id="documentation" tabindex="-1" aria-labelledby="documentationLabel" aria-hidden="true"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                if (!$documentation_data) {
                    ...
                    // 🔒 Safe render
                    $safe_html = $purifier->purify($documentation_data['full_documentation']);
                    ?>
                    ...
                    <div class="container mt-4 responsive">
                        <h3><?= htmlspecialchars($documentation_data['feature_title']) ?></h3>
                        <p><strong>Page:</strong> <?= htmlspecialchars($documentation_data['page_name']) ?> |
                            <strong>Feature:</strong> <?= htmlspecialchars($documentation_data['feature_name']) ?>
                        </p>
                        <p><strong>Version:</strong> <?= htmlspecialchars($documentation_data['version']) ?></p>
                        <hr>
