...
// Fetch student data
$sql_student = "SELECT stnameeng, stnameben, fname, mname, sscroll, regdno, gpa, gla, passyear FROM students WHERE stid = ? AND sccode = ?";
