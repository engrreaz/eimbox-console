...
<div class="container py-4">
  <div class="row g-0">
    ...
    <div class="col-lg-4 border-end">
      ...
      <div> ticket close by user | ticket status update | ticket description fixed thakbe. then chat | description /
        ticket boro hole split korar bebostha korte hobe</div>
