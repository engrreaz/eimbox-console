...
CREATE TABLE `accounts_heads` (
  ...
  `head_type` enum('income','expense','asset','liability') DEFAULT NULL,
...
CREATE TABLE `api` (
  ...
  `api_secret` varchar(20) DEFAULT NULL,
  `allowed_id` varchar(100) DEFAULT NULL,
...
CREATE TABLE `areas` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4199 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `calendar_event_visibility` (
  ...
  `viewer` enum('student','teacher','parent','staff') NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `calendar_events` (
  ...
  `target_type` enum('ALL','CLASS','SECTION') DEFAULT 'ALL',
...
CREATE TABLE `events` (
  ...
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `event_type` enum('holiday','exam','class','sports','meeting','notice','other') NOT NULL DEFAULT 'other',
  `scope` enum('institution','personal') NOT NULL DEFAULT 'institution',
...
CREATE TABLE `inoutdata` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30058855 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=16978 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `package_settings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `package_id` int(11) NOT NULL,
  `ins_tier` enum('A','B','C','D','E') DEFAULT NULL,
  `price` decimal(10,2) DEFAULT 0.00,
  `total_uses_limit` int(11) DEFAULT NULL,
  `photo_upload` int(11) DEFAULT NULL,
  ...
  `panel` varchar(150) DEFAULT NULL,
  `status` enum('active','inactive') DEFAULT 'active',
  PRIMARY KEY (`id`)
...
CREATE TABLE `scinfo` (
  ...
  `billing_data` varchar(100) DEFAULT NULL,
  `valid_module` varchar(255) NOT NULL DEFAULT 'Result',
  `active_module` varchar(255) NOT NULL DEFAULT 'Result',
  `valid_panel` varchar(100) DEFAULT NULL,
  `active_panel` varchar(100) DEFAULT NULL,
...
CREATE TABLE `sms_templete` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sccode` int(11) DEFAULT NULL,
  `temp_type` varchar(20) DEFAULT NULL,
  `temp_title` varchar(100) DEFAULT NULL,
  `temp_text` varchar(500) DEFAULT NULL,
  `created_by` varchar(100) DEFAULT NULL,
...
CREATE TABLE `stfinance` (
  ...
  `splitid2` int(11) DEFAULT NULL,
  `scan_status` int(11) NOT NULL DEFAULT 3,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=670654 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `stmark` (
  ...
  `excnt` int(11) NOT NULL DEFAULT 1,
  `entrydate` timestamp NOT NULL DEFAULT current_timestamp(),
  `entryby` varchar(64) DEFAULT NULL,
  `modifieddate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=332715 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `stpr` (
  ...
  `collection_media` varchar(15) NOT NULL DEFAULT 'Cash',
  `modifieddate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7450 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `subscription_history` (
  ...
  `package_name` varchar(11) DEFAULT NULL,
  `tier` varchar(1) DEFAULT NULL,
  `billing_data` varchar(200) DEFAULT NULL,
  `subscribe_by` varchar(100) DEFAULT NULL,
...
CREATE TABLE `subsetup` (
  ...
  `modifieddate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8866 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
CREATE TABLE `tabulatingsheet` (
  ...
  `modifieddate` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=188843 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `usersapp` (
  ...
  `is_chief` int(11) NOT NULL DEFAULT 0,
...
-- Dump completed on 2026-01-31  1:22:03
