            ...
            <div class="container-xxl flex-grow-1 container-p-y px-12 py-6">
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-danger text-center text-center fs-5 fw-bold">Payment Falure.</div>
                        <div class="row">
                            <div class="col-12 text-center">
                                <button class="btn btn-sm btn-dark " onclick="window.location.href = 'student-payable.php';">Go Back</button>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container-xxl flex-grow-1 container-p-y px-12 py-6">
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info text-center fs-5 fw-bold">Payment Cancelled.</div>
                        <div class="row">
                            <div class="col-12 text-center">
                                <button class="btn btn-sm btn-dark" onclick="window.location.href = 'student-payable.php';">Go Back</button>
                            </div>
        ...
        header("location: student-payable.php");
        exit;
    } else {
        header("location: student-payable.php");
        exit;
